<html>
    ...
    <body>
        ...
        function createPoint(coordinate, color,name,id,type,owner,date,business){
        ...
        function setAllPoint(arr){
            ...
            arr.map(function(e){
                ...
                var temp = createPoint(pointToArray(e),"#FF00FF",e.locationName,e.id,e.type,e.owner,e.date,e.name);
                map.addLayer(temp);
